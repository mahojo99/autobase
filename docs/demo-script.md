...
**2:35–3:20 — Show a failure and retained retry.** Send **Demonstrate helper failure and recovery**. The researcher deliberately fails and the parent records a partial/blocked result. In **Work**, inspect the failed child and choose **Retry with a new attempt**. Show failed attempt 1 and completed attempt 2. The original parent's failure remains historical; it is not rewritten to imply it originally succeeded.
