...
Autobase's application code and visual identity were written for this independent project, originally named Relay. OpenMausBot was general product inspiration in the owner's brief. Grok Bot's conversational layout informed the owner's dark-mode redesign request; no code or visual assets from either product were reused. The owner selected Transformers-inspired bot names; the Autobase letterform and initials avatars are original.
